...
function FilmDetails() {
  ...
  const { filmDetails, fetchDetails, isLoading, isError } = useFilmStore();
          ...
          <div className="p-14">
            ...
            <div className="flex flex-col md:flex-row gap-10 mt-12">
                ...
                <div className="flex flex-col gap-2 mt-8">
                  <div className="ratingContainer">
                    ...
                    <svg
                      ...
                      viewBox="0 0 448 512"
                      className="w-[50px] h-[50px] md:w-[40px] md:h-[40px] fill-current text-mango"
                    >
                  ...
                  <div className="ratingContainer">
                    ...
                    <svg
                      ...
                      className="w-[50px] h-[50px] md:w-[40px] md:h-[40px] fill-current text-[#ff3008]"
                    >
              ...
              <div className="flex flex-col gap-4">
                ...
                <div>
                  <h2 className="detailHeading">Director:</h2>
                  <p className="detailPara">{filmDetails.Director}</p>
                </div>
                <div>
